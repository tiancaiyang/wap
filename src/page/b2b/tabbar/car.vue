<template>
    <div>
            ...
            <div class="everyShop"   v-for="(item, index) in goodsCarList" :key="item.shop_id">
                <div class="listTop mui-clearfix">
                    ...
                    <div class="mui-input-row mui-checkbox mui-left mui-pull-left">
                        <label></label>
                        <input name="checkbox" value="Item 1" type="checkbox"  @click="chooseShopGoods(index)" v-model="item.checked" >
                    </div>
                    <div class="shop">
                        ...
                        <div class="mui-slider-handle">
                            <div class="listInfo">
                                ...
                                <div class="mui-input-row mui-checkbox mui-left">
                                    <label></label>
                                    <input name="checkbox" value="Item 1" type="checkbox" v-model="data.checked"  @click="choose(index, datatIndex)">
                                </div>
                                <img :src="data.thumb" alt="">
                                <div class="info">
                                    <h3 class="mui-ellipsis-2">{{ data.title }}</h3>
                                    <div class="price-num">
        ...
        <div class="allchoose" v-if="!goodsCarList.length == 0">
               <div class="mui-input-row mui-checkbox mui-left">
                    <label></label>
                    <input name="checkbox" value="Item 1" type="checkbox"  @click="chooseAllGoods()" v-model="allChecked">
                </div>   
             <span class="grey">全选</span>
             <span class="red"  v-show="trueactive">￥<i>{{ $store.getters.priceAll.amount | strip }}</i></span>
...
<script>
    ...
    import CarNumBox from '../../../components/GoodsCarNUmBox.vue'
    import NullCar from '../../../components/nullCar.vue'
    import mui from '../../../../static/mui/js/mui.min.js'
    import { b2bcar,b2bCarDel,b2bCarDelAll } from '../../../api/index.js'
    export default {
        inject :['reload'],
        name: 'car',
        components:{
        ...
        methods:{
            ...
            getCarList(){
                b2bcar().then(res=>{
                    ...
                    this.$store.commit("addB2bCar",res.data)
            ...
            sumbitCartBuy(){
                ...
                this.$router.push({name:'cartBuyB', query: param })
            }

<template>
    <div>
        ...
        <div class="assortDiv mui-clearfix">
            ...
            <!-- 右侧 -->
            <div class="right">
               <div class="lunbo"><swiperb :list="bannerList"></swiperb></div>
                <div class="mui-scroll-wrapper">
                    <div class="mui-scroll">
                        <ul class="firsttUl">
...
<script>
   ...
   import { b2baccress,b2baccresscategory } from '../../../api/index.js'
    export default {
        components: {
            swiperb,
            tabbar
        ...
        methods:{
            ...
            getDataCategory(){
                ...
                b2baccresscategory(params).then(res=>{
            ...
            toAssementInfo(cid,name,type){
                if(type == 'brand'){
                    this.$router.push({ name: 'assestCoodsListB', query:{cid:cid,title:name,type:type} })
                }else if(type == 'cat'){
                    this.$router.push({ name: 'brandGoodsListB', query:{cid:cid,title:name,type:type} })
                }
            }

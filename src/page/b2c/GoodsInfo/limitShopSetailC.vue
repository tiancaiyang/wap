                ...
                <div class="goodsinfo">
                    ...
                    <div class="discountPrice PriceDiv" v-if="shopListData.activity_type== 1">
                        <h3>
                            ...
                            <span class="mui-pull-right">特价商品</span>
                        </h3>
                    </div>
    ...
    export default {
        ...
        methods:{
            ...
            getSelectedCount(count){
                ...
                if( this.selectedCount > parseInt(this.shopListData.every_num) ){
                    this.selectedCount = this.shopListData.every_num
                    mui.toast('超过了限购数量')
                    // this.reload()//刷新页面
                }
            },
            ...
            addShopCar(){
                let params = {
                    ...
                    // brand_member_pos_id: this.shopListData.brand_member_pos_id,//业务员id c端不需要

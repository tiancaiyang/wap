<template>
    <div>
        <header id="header" class="mui-bar mui-bar-nav">
            ...
            <span class="searchBtn" @click="getSearch">搜索</span>
		</header>
...
<script>
    import searchResoult from '../../../components/Shoplist.vue'
    import mui from '../../../../static/mui/js/mui.min.js'
    import { b2cOHomeSearch } from '../../../api/index.js'
    export default {
        data() {
            return {
                value:'',
        ...
        methods:{
            ...
            getSearch(){
                ...
                if(this.value == "" || reg.test(this.value)){
                    ...
                    b2cOHomeSearch(params).then(res=>{

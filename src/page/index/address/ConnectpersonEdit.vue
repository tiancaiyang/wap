           ...
           <ul class="mui-table-view">
                ...
                <li class="mui-table-view-cell selectAddressDiv">
                    <a id='showCityPicker3' class="mui-navigate-right" @click="selectAddress">
                        ...
                        <input type="text" name="" id="addressSelect" disabled :value="area">
                ...
                <li class="mui-table-view-cell defaultAddress">
                    ...
                    <div class="mui-switch" :class="this.default == 1 ? 'mui-active': ''" @click="setDefault">
...
<script>
    ...
    import { IndexAddressEdit } from '../../../api/index.js'
    export default {
        data() {
            return {
                ...
                default: this.$route.params.default,
            }
        },
        mounted(){
            mui.init();
        ...
        methods:{
            ...
            addAddressData(){
                ...
                IndexAddressEdit(param).then(res=>{
                    //返回上一页
                    mui.toast('修改成功',{ duration:500 });

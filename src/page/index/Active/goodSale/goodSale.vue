                        ...
                        <div class="mui-media-body">
                            ...
                            <div class="info mui-clearfix">
                                ...
                                <div class="mui-pull-right">
                                    <router-link :to="'/shopdetailC/' + item.product_id"  tag="button" type="button" class="mui-btn mui-btn-danger" v-if="item.ratio != 100">立即抢购</router-link>
...
<script>
    ...
    import { b2cSaleActivity  } from '../../../../api/index.js'

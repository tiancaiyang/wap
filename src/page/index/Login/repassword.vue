        ...
        <div class="mui-content">
			<form id='login-form' class="mui-input-group">
                ...
                <div class="mui-input-row">
					<label>验证码</label>
					<input  type="text"  v-model="code" class="" placeholder="请输入验证码">
                </div>
				<div class="mui-input-row">
					<label>设置密码</label>
                ...
                <div class="mui-input-row">
					<label>确认密码</label>
					<input v-model="repassword" type="password"  class="mui-input-password" placeholder="请输入密码">
				</div>
			</form>
			<div class="mui-content-padded">
				<a  @click="RePasswordSuccess"><button id='login' class="mui-btn mui-btn-danger mui-btn-outlined">确定</button></a>
			</div>
        </div>    
    </div>
</template>
...
<script>
    ...
    import { RegisterCode,RePassword } from '../../../api/index.js'
